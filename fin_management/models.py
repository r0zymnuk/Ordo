...
currency = [['AED', 'United Arab Emirates Dirham'], ['AFN', 'Afghan Afghani'], ['ALL', 'Albanian Lek'], ['AMD', 'Armenian Dram'],
            ...
            ['BWP', 'Botswanan Pula'], ['BYN', 'Belarusian Ruble'], ['BZD', 'Belize Dollar'], ['CAD', 'Canadian Dollar'],
            ['CDF', 'Congolese Franc'], ['CHF', 'Swiss Franc'], ['CLF', 'Chilean Unit of Account (UF)'], ['CLP', 'Chilean Peso'],
            ['CNH', 'Chinese Yuan (Offshore)'], ['CNY', 'Chinese Yuan'], ['COP', 'Colombian Peso'], ['CRC', 'Costa Rican Colón'],
            ...
            ['FJD', 'Fijian Dollar'], ['FKP', 'Falkland Islands Pound'], ['GBP', 'British Pound Sterling'],
            ...
            ['MNT', 'Mongolian Tugrik'], ['MOP', 'Macanese Pataca'], ['MRO', 'Mauritanian Ouguiya (pre-2018)'],
            ...
            ['UZS', 'Uzbekistan Som'], ['VEF', 'Venezuelan Bolívar Fuerte (Old)'], ['VES', 'Venezuelan Bolívar Soberano'],
            ['VND', 'Vietnamese Dong'], ['VUV', 'Vanuatu Vatu'], ['WST', 'Samoan Tala'], ['XAF', 'CFA Franc BEAC'],
            ['XAG', 'Silver Ounce'], ['XAU', 'Gold Ounce'], ['XCD', 'East Caribbean Dollar'], ['XDR', 'Special Drawing Rights'],
            ['XOF', 'CFA Franc BCEAO'], ['XPD', 'Palladium Ounce'], ['XPF', 'CFP Franc'], ['XPT', 'Platinum Ounce'],
...
class Transaction(Base):
    ...
    type: Literal["income", "spending"]
    amount: float = 0
    transaction_time: datetime.datetime = datetime.datetime.now()
